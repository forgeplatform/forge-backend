...
# Base image selection: centos (default) or ubuntu
BASE_IMAGE ?= centos
...
Dockerfile.dev: tools/ansible/roles/dockerfile/templates/$(DOCKERFILE_TEMPLATE)
...
Dockerfile: tools/ansible/roles/dockerfile/templates/$(DOCKERFILE_TEMPLATE)
	$(ANSIBLE_PLAYBOOK) tools/ansible/dockerfile.yml \
		-e receptor_image=$(RECEPTOR_IMAGE) \
		-e headless=$(HEADLESS) \
		-e dockerfile_template=$(DOCKERFILE_TEMPLATE)
...
Dockerfile.kube-dev: tools/ansible/roles/dockerfile/templates/$(DOCKERFILE_TEMPLATE)
	$(ANSIBLE_PLAYBOOK) tools/ansible/dockerfile.yml \
