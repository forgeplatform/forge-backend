...
COLOR_LOGS = True
LOGGING['handlers']['console']['()'] = 'forge.main.utils.handlers.ColorHandler'  # noqa
...
# Only works in combination with settings.SETTINGS_MODULE == 'forge.settings.development'
