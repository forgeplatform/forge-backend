...
from forge.main.migrations import _migration_utils as migration_utils
from forge.main.migrations._multi_cred import migrate_workflow_cred, migrate_workflow_cred_reverse
from forge.main.migrations._scan_jobs import remove_scan_type_nodes
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extra_data', forge.main.fields.JSONBlob(blank=True, default=dict)),
                ('survey_passwords', forge.main.fields.JSONBlob(blank=True, default=dict, editable=False)),
                ('char_prompts', forge.main.fields.JSONBlob(blank=True, default=dict)),
        ...
        migrations.AddField(
            ...
            field=forge.main.fields.AskForField(blank=True, default=False),
        ),
