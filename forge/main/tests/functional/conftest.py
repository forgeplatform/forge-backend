...
from forge.main.migrations._dab_rbac import setup_managed_role_definitions

# AWX
from forge.main.models.projects import Project
from forge.main.models.ha import Instance, InstanceGroup
...
from forge.main.models.credential import CredentialType, Credential
from forge.main.models.jobs import JobTemplate, SystemJobTemplate
from forge.main.models.inventory import Group, Inventory, InventoryUpdate, InventorySource
from forge.main.models.organization import (
    Organization,
    Team,
)
from forge.main.models.notifications import NotificationTemplate, Notification
from forge.main.models.events import (
    JobEvent,
    AdHocCommandEvent,
    ProjectUpdateEvent,
...
from forge.main.models.workflow import WorkflowJobTemplate
from forge.main.models.ad_hoc_commands import AdHocCommand
from forge.main.models.oauth import OAuth2Application as Application
from forge.main.models.execution_environments import ExecutionEnvironment
from forge.main.utils import is_testing
...
def run_computed_fields_right_away(request):
    ...
    mocked = mock.patch('forge.main.signals.update_inventory_computed_fields.delay', new=run_me)
    mocked.start()
...
def credentialtype_external():
    ...
    with mock.patch('forge.main.models.credential.CredentialType.plugin', new_callable=PropertyMock) as mock_plugin:
...
def scm_inventory_source(inventory, project):
    ...
    with mock.patch('forge.main.models.unified_jobs.UnifiedJobTemplate.update'):
        inv_src.save()
    return inv_src
...
def disable_database_settings(mocker):
    m = mocker.patch('forge.conf.settings.SettingsWrapper.all_supported_settings', new_callable=PropertyMock)
    m.return_value = []
