...
from forge.main.management.commands.host_metric_summary_monthly import Command
from forge.main.models.inventory import HostMetric, HostMetricSummaryMonthly
from forge.main.tests.factories.fixtures import mk_host_metric, mk_host_metric_summary
