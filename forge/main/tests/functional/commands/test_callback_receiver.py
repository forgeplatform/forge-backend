...
from forge.main.dispatch.worker.callback import job_stats_wrapup, CallbackBrokerWorker

from forge.main.models.jobs import Job
from forge.main.models.inventory import InventoryUpdate, InventorySource
from forge.main.models.events import InventoryUpdateEvent
...
def test_wrapup_does_not_send_notifications(mocker):
    ...
    mock = mocker.patch('forge.main.models.notifications.JobNotificationMixin.send_notification_templates')
...
class TestCallbackBrokerWorker(TransactionTestCase):
    ...
    def turn_off_websockets(self):
        with mock.patch('forge.main.dispatch.worker.callback.emit_event_detail', lambda *a, **kw: None):
            yield
