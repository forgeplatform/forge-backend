...
from forge.main.models.workflow import WorkflowJobTemplate, WorkflowJobTemplateNode, WorkflowApprovalTemplate
from forge.main.models.jobs import JobTemplate
from forge.main.tasks.system import deep_copy_model_obj
from forge.main.models import Label, ExecutionEnvironment, InstanceGroup
...
def test_inventory_copy(inventory, group_factory, post, get, alice, organization):
    ...
    with mock.patch('forge.api.generics.trigger_delayed_deep_copy') as deep_copy_mock:
