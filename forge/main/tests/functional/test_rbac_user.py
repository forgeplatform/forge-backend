...
from forge.main.access import UserAccess, RoleAccess, TeamAccess
from forge.main.models import User, Organization, Inventory, get_system_auditor_role
...
def test_manage_org_auth_setting(ext_auth, superuser, expect, organization, rando, user, team):
    ...
    with mock.patch('forge.main.access.settings') as settings_mock:
