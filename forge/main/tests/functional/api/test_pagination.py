...
from forge.main.models.inventory import Group, Host
from forge.main.models.ad_hoc_commands import AdHocCommand
from forge.api.pagination import Pagination
...
def test_pagination_cap_page_size(get, admin, inventory):
    ...
    with patch('forge.api.pagination.Pagination.max_page_size', 5):
