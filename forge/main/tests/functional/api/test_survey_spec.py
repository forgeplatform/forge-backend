...
from forge.main.models.activity_stream import ActivityStream
from forge.main.access import JobTemplateAccess
...
@mock.patch('forge.main.models.unified_jobs.UnifiedJobTemplate.create_unified_job', lambda self, **kwargs: mock.MagicMock(spec=Job, id=968))
@mock.patch('forge.api.serializers.JobSerializer.to_representation', lambda self, obj: {})
@pytest.mark.django_db
@pytest.mark.survey
