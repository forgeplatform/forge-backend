...
from forge.main.models import Inventory
from django.db import DatabaseError


@pytest.fixture
def mock_logger():
    with patch("forge.main.tasks.system.logger") as logger:
        yield logger
...
def test_update_inventory_computed_fields_existing_inventory(mock_logger, mock_inventory):
    ...
    with patch("forge.main.tasks.system.Inventory.objects.filter") as mock_filter:
