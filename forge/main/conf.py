...
# AWX
from forge.conf import fields, register, register_validate
from forge.main.models import ExecutionEnvironment
from forge.main.constants import SUBSCRIPTION_USAGE_MODEL_UNIQUE_HOSTS

logger = logging.getLogger('forge.main.conf')
...
register(
    ...
    field_class=fields.StringListField,
    default=['forge', 'activity_stream', 'job_events', 'system_tracking', 'broadcast_websocket'],
...
register(
    ...
    help_text=_(
        ...
        'forge.anlytics ignore this setting)'
    ),
    category=_('Logging'),
    category_slug='logging',
)
...
register(
    ...
    field_class=fields.BooleanField,
    default=True,
    label=_('Enable Legacy User Interface'),
    help_text=_('Enable access to the legacy user interface at /ui_legacy/.'),
    category=_('System'),
    category_slug='system',
)
