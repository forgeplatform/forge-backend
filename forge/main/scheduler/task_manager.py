...
# AWX
from forge.main.dispatch.reaper import reap_job
...
from forge.main.utils.common import task_manager_bulk_reschedule, is_testing
from forge.main.signals import disable_activity_stream
from forge.main.constants import ACTIVE_STATES
from forge.main.scheduler.dependency_graph import DependencyGraph
...
from forge.main.utils import decrypt_field
...
class TaskManager(TaskBase):
    ...
    def process_tasks(self):
        ...
        if self.pre_start_failed:
            from forge.main.tasks.system import handle_failure_notifications
