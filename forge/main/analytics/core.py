...
from forge.main.models import Job
from forge.main.access import access_registry
from forge.main.utils import get_awx_http_client_headers, set_environ, datetime_hook
from forge.main.utils.pglock import advisory_lock

__all__ = ['register', 'gather', 'ship']


logger = logging.getLogger('forge.main.analytics')
...
def all_collectors():
    from forge.main.analytics import collectors
