...
from forge.main.utils import get_awx_version, camelcase_to_underscore, datetime_hook
from forge.main import models
from forge.main.analytics import register
...
def host_metric_slicing(key, since, until, last_gather, **kwargs):
    ...
    """
    from forge.main.models.inventory import HostMetric
