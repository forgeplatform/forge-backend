...
class Licenser(object):
    ...
    def validate(self):
        ...
        from forge.main.models import Host, HostMetric, Instance
...
def get_licenser(*args, **kwargs):
    from forge.main.utils.licensing import Licenser, OpenLicense
...
def server_product_name():
    return 'Forge' if isinstance(get_licenser(), OpenLicense) else 'Red Hat Ansible Automation Platform'
