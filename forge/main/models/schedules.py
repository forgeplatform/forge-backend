...
from forge.main.fields import OrderedManyToManyField
from forge.main.models.base import PrimordialModel
from forge.main.models.jobs import LaunchTimeConfig
...
logger = logging.getLogger('forge.main.models.schedule')
...
class Schedule(PrimordialModel, LaunchTimeConfig):
    ...
    def __str__(self):
        return u'%s_t%s_%s_%s' % (self.name, self.unified_job_template_id, self.id, self.next_run)
