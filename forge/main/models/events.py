...
from forge.main.fields import JSONBlob
from forge.main.managers import DeferJobCreatedManager
from forge.main.constants import MINIMAL_EVENTS
from forge.main.models.base import CreatedModifiedModel
from forge.main.utils import ignore_inventory_computed_fields, camelcase_to_underscore

analytics_logger = logging.getLogger('forge.analytics.job_events')

logger = logging.getLogger('forge.main.models.events')
...
class JobEvent(BasePlaybookEvent):
    ...
    def _update_host_summary_from_stats(self, hostnames):
        with ignore_inventory_computed_fields():
            ...
            from forge.main.models import Host, JobHostSummary  # circular import
    ...
    def _update_host_metrics(updated_hosts_list):
        from forge.main.models import HostMetric  # circular import
