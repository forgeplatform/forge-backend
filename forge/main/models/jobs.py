...
from forge.main.constants import HOST_FACTS_FIELDS
from forge.main.models.base import (
    BaseModel,
...
from forge.main.models.events import JobEvent, UnpartitionedJobEvent, UnpartitionedSystemJobEvent, SystemJobEvent
from forge.main.models.unified_jobs import UnifiedJobTemplate, UnifiedJob
from forge.main.models.notifications import (
    NotificationTemplate,
    JobNotificationMixin,
)
from forge.main.utils import parse_yaml_or_json, getattr_dne, NullablePromptPseudoField, polymorphic
from forge.main.fields import ImplicitRoleField, AskForField, JSONBlob, OrderedManyToManyField
...
from forge.main.constants import JOB_VARIABLE_PREFIXES
...
class JobTemplate(UnifiedJobTemplate, JobOptions, SurveyJobTemplateMixin, ResourceMixin, CustomVirtualEnvMixin, RelatedJobsMixin, WebhookTemplateMixin):
    ...
    def create_unified_job(self, **kwargs):
        ...
        if slice_event:
            ...
            from forge.main.models.workflow import WorkflowJobTemplate, WorkflowJobNode
    ...
    def notification_templates(self):
        ...
        error_q = Q(unifiedjobtemplate_notification_templates_for_errors__in=[self, self.project])
        started_q = Q(unifiedjobtemplate_notification_templates_for_started__in=[self, self.project])
        success_q = Q(unifiedjobtemplate_notification_templates_for_success__in=[self, self.project])
...
class Job(UnifiedJob, JobOptions, SurveyJobMixin, JobNotificationMixin, TaskManagerJobMixin, CustomVirtualEnvMixin, WebhookMixin):
    ...
    def _get_task_class(cls):
        from forge.main.tasks.jobs import RunJob
...
class JobHostSummary(CreatedModifiedModel):
    ...
    def save(self, *args, **kwargs):
        ...
        if self.host is not None:
            ...
            if update_fields and 'host_name' not in update_fields:
                update_fields.append('host_name')
        self.failed = bool(self.dark or self.failures)
        if update_fields and 'failed' not in update_fields:
...
class SystemJob(UnifiedJob, SystemJobOptions, JobNotificationMixin):
    ...
    @classmethod
    def _get_task_class(cls):
        from forge.main.tasks.jobs import RunSystemJob
