...
# AWX
from forge.main.models.base import CommonModelNameNotUnique, PasswordFieldsModel, NotificationFieldsModel
from forge.main.dispatch import get_task_queuename
from forge.main.dispatch.control import Control as ControlDispatcher
from forge.main.registrar import activity_stream_registrar
from forge.main.models.mixins import TaskManagerUnifiedJobMixin, ExecutionEnvironmentMixin
from forge.main.models.rbac import to_permissions
from forge.main.utils.common import (
...
from forge.main.utils.encryption import encrypt_dict, decrypt_field
from forge.main.utils import polymorphic
from forge.main.constants import ACTIVE_STATES, CAN_CANCEL, JOB_VARIABLE_PREFIXES
from forge.main.redact import UriCleaner, REPLACE_STR
from forge.main.consumers import emit_channel_notification
from forge.main.fields import AskForField, OrderedManyToManyField

__all__ = ['UnifiedJobTemplate', 'UnifiedJob', 'StdoutMaxBytesExceeded']

logger = logging.getLogger('forge.main.models.unified_jobs')
logger_job_lifecycle = logging.getLogger('forge.analytics.job_lifecycle')
...
class UnifiedJobTemplate(PolymorphicModel, CommonModelNameNotUnique, ExecutionEnvironmentMixin, NotificationFieldsModel):
    ...
    def notification_templates(self):
        ...
        from forge.main.models.notifications import NotificationTemplate
    ...
    def create_unified_job(self, instance_groups=None, **kwargs):
        ...
        from forge.main.signals import disable_activity_stream, activity_stream_create
...
class UnifiedJob(
    ...
    def result_stdout_text(self, value):
        # DEPRECATED: Remove once all stdout is based on job events.
    ...
    def result_stdout_raw_handle(self, enforce_max_bytes=True):
        ...
        if enforce_max_bytes:
            ...
            from forge.main.tasks.system import purge_old_stdout_files  # circular import
    ...
    def control_plane_instance_group(self):
        from forge.main.models.ha import InstanceGroup
