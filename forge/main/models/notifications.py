...
from forge.main.utils import encrypt_field, decrypt_field, set_environ
from forge.main.notifications.email_backend import CustomEmailBackend
from forge.main.notifications.slack_backend import SlackBackend
from forge.main.notifications.twilio_backend import TwilioBackend
from forge.main.notifications.pagerduty_backend import PagerDutyBackend
from forge.main.notifications.webhook_backend import WebhookBackend
from forge.main.notifications.mattermost_backend import MattermostBackend
from forge.main.notifications.grafana_backend import GrafanaBackend
from forge.main.notifications.rocketchat_backend import RocketChatBackend
from forge.main.notifications.irc_backend import IrcBackend
from forge.main.notifications.awssns_backend import AWSSNSBackend


logger = logging.getLogger('forge.main.models.notifications')
...
class JobNotificationMixin(object):
 ...
 'created_by': 'admin'}""",
    ...
    def build_notification_message(self, nt, status):
        ...
        from forge.api.serializers import UnifiedJobSerializer
