...
from forge.main.managers import InstanceManager, UUID_DEFAULT
from forge.main.constants import JOB_FOLDER_PREFIX
from forge.main.models.base import BaseModel, HasEditsMixin
from forge.main.models.rbac import (
    ROLE_SINGLETON_SYSTEM_ADMINISTRATOR,
    ROLE_SINGLETON_SYSTEM_AUDITOR,
)
from forge.main.models.unified_jobs import UnifiedJob
from forge.main.utils.common import get_corrected_cpu, get_cpu_effective_capacity, get_corrected_memory, get_mem_effective_capacity
from forge.main.models.mixins import RelatedJobsMixin, ResourceMixin
from forge.main.models.receptor_address import ReceptorAddress
...
logger = logging.getLogger('forge.main.models.ha')
...
def schedule_policy_task():
    from forge.main.tasks.system import apply_cluster_membership_policies
...
def schedule_write_receptor_config(broadcast=True):
    from forge.main.tasks.receptor import write_receptor_config  # prevents circular import
...
def on_instance_saved(sender, instance, created=False, raw=False, **kwargs):
    ...
    if settings.IS_K8S and instance.node_type in [Instance.Types.HOP, Instance.Types.EXECUTION]:
        if instance.node_state == Instance.States.DEPROVISIONING:
            from forge.main.tasks.receptor import remove_deprovisioned_node  # prevents circular import
