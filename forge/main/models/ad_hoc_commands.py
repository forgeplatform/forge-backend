...
from forge.main.models.base import AD_HOC_JOB_TYPE_CHOICES, VERBOSITY_CHOICES, VarsDictProperty
from forge.main.models.events import AdHocCommandEvent, UnpartitionedAdHocCommandEvent
from forge.main.models.unified_jobs import UnifiedJob
from forge.main.models.notifications import JobNotificationMixin, NotificationTemplate

logger = logging.getLogger('forge.main.models.ad_hoc_commands')
...
class AdHocCommand(UnifiedJob, JobNotificationMixin):
    ...
    def _get_task_class(cls):
        from forge.main.tasks.jobs import RunAdHocCommand
