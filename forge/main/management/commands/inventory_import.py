...
from forge.main.models.inventory import Inventory, InventorySource, InventoryUpdate, Host
from forge.main.utils.mem_inventory import MemInventory, dict_to_mem_data
from forge.main.utils.safe_yaml import sanitize_jinja

# other AWX imports
from forge.main.models.rbac import batch_role_ancestor_rebuilding
from forge.main.utils import ignore_inventory_computed_fields, get_licenser
from forge.main.utils.execution_environments import get_default_execution_environment
from forge.main.signals import disable_activity_stream
from forge.main.constants import STANDARD_INVENTORY_UPDATE_ENV
from forge.main.utils.pglock import advisory_lock

logger = logging.getLogger('forge.main.commands.inventory_import')
