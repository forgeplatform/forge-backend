...
from forge.main.constants import (
...
from forge.main.tasks.callback import (
    RunnerCallback,
...
from forge.main.tasks.signals import with_signal_handling, signal_callback
from forge.main.tasks.receptor import AWXReceptorJob
from forge.main.tasks.facts import start_fact_cache, finish_fact_cache
from forge.main.exceptions import AwxTaskError, PostRunError, ReceptorNodeNotFound
from forge.main.utils.ansible import read_ansible_config
from forge.main.utils.execution_environments import CONTAINER_ROOT, to_container_path
from forge.main.utils.safe_yaml import safe_dump, sanitize_jinja
...
from forge.conf.license import get_license
from forge.main.utils.handlers import SpecialInventoryHandler
from forge.main.tasks.system import update_smart_memberships_for_inventory, update_inventory_computed_fields
from forge.main.utils.update_model import update_model
from rest_framework.exceptions import PermissionDenied
from django.utils.translation import gettext_lazy as _

logger = logging.getLogger('forge.main.tasks.jobs')
...
class RunInventoryUpdate(SourceControlMixin, BaseTask):
    ...
    def post_run_hook(self, inventory_update, status):
        ...
        inv_logger = logging.getLogger('forge.main.commands.inventory_import')
        formatter = inv_logger.handlers[0].formatter
        formatter.job_start = inventory_update.started
        handler.formatter = formatter
        inv_logger.handlers[0] = handler

        from forge.main.management.commands.inventory_import import Command as InventoryImportCommand
