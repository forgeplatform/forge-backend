...
from forge.main.models.inventory import Host


logger = logging.getLogger('forge.main.tasks.facts')
system_tracking_logger = logging.getLogger('forge.analytics.system_tracking')
