...
from forge.main.constants import MINIMAL_EVENTS, ANSIBLE_RUNNER_NEEDS_UPDATE_MESSAGE
from forge.main.utils.update_model import update_model
from forge.main.queue import CallbackQueueDispatcher

logger = logging.getLogger('forge.main.tasks.callback')
    ...
    def status_handler(self, status_data, runner_config):
        ...
        if status_data['status'] == 'starting':
            ...
            for k, v in self.safe_env.items():
                if k in job_env:
                    job_env[k] = v
            from forge.main.signals import disable_activity_stream  # Circular import
