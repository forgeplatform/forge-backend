...
from forge.sso.ldap_group_types import PosixUIDGroupType  # noqa

# AWX
from forge.conf import fields
from forge.main.validators import validate_certificate
from forge.sso.validators import (  # noqa
    validate_ldap_dn,
...
def find_class_in_modules(class_name):
    ...
    """
    module_search_space = [django_auth_ldap.config, forge.sso.ldap_group_types]
...
class AuthenticationBackendsField(fields.StringListField):
    ...
    REQUIRED_BACKEND_SETTINGS = collections.OrderedDict(
        [
            ('forge.sso.backends.LDAPBackend', ['AUTH_LDAP_SERVER_URI']),
            ('forge.sso.backends.LDAPBackend1', ['AUTH_LDAP_1_SERVER_URI']),
            ('forge.sso.backends.LDAPBackend2', ['AUTH_LDAP_2_SERVER_URI']),
            ('forge.sso.backends.LDAPBackend3', ['AUTH_LDAP_3_SERVER_URI']),
            ('forge.sso.backends.LDAPBackend4', ['AUTH_LDAP_4_SERVER_URI']),
            ('forge.sso.backends.LDAPBackend5', ['AUTH_LDAP_5_SERVER_URI']),
            ('forge.sso.backends.RADIUSBackend', ['RADIUS_SERVER']),
