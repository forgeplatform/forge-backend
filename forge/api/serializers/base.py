...
"""
Base serializer classes and utilities for Forge API.

This module contains the fundamental serializer classes that other serializers inherit from,
as well as constants and helper functions used throughout the API serializers.
"""
...
# AWX
from forge.main.access import get_user_capabilities
...
from forge.main.models.rbac import role_summary_fields_generator  # exported for tests
...
from forge.main.utils.named_url_graph import reset_counters

from forge.api.versioning import reverse
from forge.api.fields import BooleanNullField, CharNullField, ChoiceNullField
...
# These fields can be edited on a constructed inventory's generated source
