...
from forge.api.generics import LoggedLoginView, LoggedLogoutView
from forge.api.views.root import (
    ApiRootView,
    ApiV2RootView,
    ApiV2PingView,
    ApiV2ConfigView,
...
from forge.api.views.bulk import (
    BulkView,
    BulkHostCreateView,
    BulkHostDeleteView,
    BulkJobLaunchView,
...
from forge.api.views.mesh_visualizer import MeshVisualizer

from forge.api.views.metrics import MetricsView
from forge.api.views.analytics import AWX_ANALYTICS_API_PREFIX
...
v2_urls = [
    ...
    re_path(r'^settings/', include('forge.conf.urls')),
...
if MODE == 'development':
    ...
    from forge.api.swagger import schema_view

    from forge.api.urls.debug import urls as debug_urls
