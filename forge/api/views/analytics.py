...
from forge.api.generics import APIView, Response
from forge.api.permissions import AnalyticsPermission
...
logger = logging.getLogger('forge.api.views.analytics')
