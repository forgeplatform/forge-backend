...
# AWX
from forge.api.generics import APIView, GenericAPIView, ListAPIView, RetrieveUpdateDestroyAPIView
...
from forge.main.tasks.system import clear_setting_cache
from forge.conf.models import Setting
from forge.conf.serializers import SettingCategorySerializer, SettingSingletonSerializer
from forge.conf import settings_registry
from forge.main.utils.external_logging import reconfigure_rsyslog
...
class SettingLoggingTest(GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if default_logger != 'forge':
                default_logger = f'forge.analytics.{default_logger}'
        except IndexError:
            default_logger = 'forge'
        logging.getLogger(default_logger).error('Forge Connection Test Message')
