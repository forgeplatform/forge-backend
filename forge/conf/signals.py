...
logger = logging.getLogger('forge.conf.signals')
...
def disable_local_auth(**kwargs):
    if (kwargs['setting'], kwargs['value']) == ('DISABLE_LOCAL_AUTH', True):
        ...
        from forge.main.models.oauth import OAuth2AccessToken
        from forge.main.management.commands.revoke_oauth2_tokens import revoke_tokens
